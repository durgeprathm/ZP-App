                            ...
                            child: MaterialButton(
                              child: Row(
                                ...
                                children: <Widget>[
                                  ...
                                  SizedBox(width: 15.0,),
                                  Text("Get Video",style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold,fontSize: 18.0),),
                                ],
                              ) ,
                              minWidth: 150,
                              height: 25.0,
                              onPressed: () async {
                                ...
                                picture = await _picker.getVideo(source: ImageSource.gallery);
                                print(picture);
                              },
                            ),
                          ),
                      ...
                      child: MaterialButton(
                        child: Row(
                          ...
                          children: <Widget>[
                            ...
                            SizedBox(width: 15.0,),
                            Text("Save",style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold,fontSize: 18.0),),
                          ],
                        ) ,
                        minWidth: 150,
                        height: 25.0,
