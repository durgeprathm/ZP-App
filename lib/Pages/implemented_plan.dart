...
class Implemented extends StatefulWidget {
  @override
  _ImplementedState createState() => _ImplementedState();
}

class _ImplementedState extends State<Implemented> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: Text("Teacher Implemented Plan"),
